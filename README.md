...
- 🔭 Full Stack Developer with ~5 years of experience delivering scalable and secure enterprise applications. Skilled in backend technologies such as **.NET, C#, Java, Spring Boot, Kafka, and Microservices**, along with frontend frameworks including **React, Microfrontends, Redux, and TypeScript**.

- Strong background in designing **modular architectures, CI/CD pipelines**, and maintaining **code quality & application security** using **Fortify, SonarQube, and IQServer**.

- Experienced in **Databricks for ETL and data engineering workloads**, building automated and manual pipelines using **Apache Spark, Scala, and SQL**.
...
- 🌱 Certified in **AWS Cloud Practitioner, AWS Developer Associate, Microsoft Azure Fundamentals, and Azure Administrator**

- 👯 I’m happy to help anyone if needed!

- 🥅 **2026 Goals:** Coding | Cloud | Gym

- ⚡ **Fun fact:** I love learning foreign languages, so it's not just **coding languages** that I speak 🤣  
  Practicing Japanese here → [Japanese][yourJapaneseSensei]
...
[![My Skills](https://skillicons.dev/icons?i=spring,dotnet,react,kafka,postgres,mysql,aws,git,postman&theme=light)](https://skillicons.dev)
...
<img src="https://github-readme-stats.vercel.app/api?username=rajdeepj1363&show_icons=true&hide_border=true"/>
